<template>
  <div class="page_body">
    ...
    <div
      ...
      <div class="refDots">
        <div class="inactive" ref="1"></div>
        <div class="active" ref="2"></div>
        <div class="inactive" ref="3"></div>
        <div class="inactive" ref="4"></div>
        <div class="inactive" ref="5"></div>
        <div class="inactive" ref="6"></div>
      </div>
    </div>
